...
! The normal situation...
          ...
          write(800+mp,7995) lp,mp,mp_t0(1),mp_t0(2), &
                             phi_t0*rad_to_deg,phi_i(1)*rad_to_deg,phi_i(2)*rad_to_deg,mp_comp_weight(1),mp_comp_weight(2)          
 7995     format('GHGM MP ',4i4,3f13.4,2f13.6)
...
!              plasma % electron_temperature(i,lp,mp) = electron_temperature_int*( ksi_fac**(4.0_prec/3.0_prec) )
 ...
 100  CONTINUE
  ...
  SUBROUTINE Cross_Flux_Tube_Transport_houjun_ksi( plasma, grid, v_ExB, time_step, &
...
!             plasma % electron_temperature(i,lp,mp) = electron_temperature_int
 ...
 100  CONTINUE
  ...
  END SUBROUTINE Cross_Flux_Tube_Transport_houjun_ksi
